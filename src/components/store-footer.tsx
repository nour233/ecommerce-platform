  ...
  return (
    <footer className="bg-[#111827] text-white">
      <div className="mx-auto grid max-w-[1500px] gap-12 px-4 py-14 sm:px-6 md:grid-cols-2 lg:grid-cols-[1.3fr_.7fr_.7fr_1.3fr] lg:px-8">
        ...
        <div><h2 className="text-sm font-semibold">Help</h2><div className="mt-5 space-y-3 text-sm text-slate-400"><Link className="block hover:text-white" href="/cart">Your cart</Link><Link className="block hover:text-white" href="/wishlist">Wishlist</Link><Link className="block hover:text-white" href="/login">Account</Link></div></div>
